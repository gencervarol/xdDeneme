  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          Pinned.fromPins(
            Pin(start: -315.0, end: 0.0),
            Pin(size: 730.0, end: -326.0),
            child: Stack(
              children: <Widget>[
                Container(
                  decoration: BoxDecoration(
                    gradient: LinearGradient(
                      ...
                      colors: [
                        const Color(0x703acbc1),
                        const Color(0x70ffd320),
                        const Color(0x70ffd21e),
                        const Color(0x7054fff4),
                        const Color(0x70808080)
                      ],
                      stops: [0.0, 0.105, 0.163, 0.473, 1.0],
                    ),
                    borderRadius:
                        BorderRadius.all(Radius.elliptical(9999.0, 9999.0)),
                    border:
                        Border.all(width: 1.0, color: const Color(0x70707070)),
                  ),
                ),
              ],
            ),
          ...
          Pinned.fromPins(
            Pin(start: -365.0, end: 0.0),
            Pin(size: 770.0, end: -384.0),
            child: Container(
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  begin: Alignment(0.0, -1.0),
          ...
          Pinned.fromPins(
            Pin(start: 70.0, end: 69.0),
            Pin(size: 40.0, middle: 0.7111),
            child: Container(
              decoration: BoxDecoration(
                color: const Color(0xffffffff),
                borderRadius: BorderRadius.circular(10.0),
                border: Border.all(width: 2.0, color: const Color(0xff474747)),
              ),
            ),
          ),
          Align(
            alignment: Alignment(-0.531, 0.054),
            child: SizedBox(
              width: 108.0,
              height: 15.0,
              child: Text(
          ...
          Align(
            alignment: Alignment(-0.624, 0.33),
            child: SizedBox(
              width: 29.0,
              height: 15.0,
              child: Text(
          ...
          Container(),
          Align(
            alignment: Alignment(-0.416, 0.574),
            child: SizedBox(
              width: 72.0,
              height: 15.0,
              child: Text(
          ...
          Align(
            alignment: Alignment(0.578, 0.574),
            child: SizedBox(
              width: 101.0,
              height: 15.0,
              child: Text(
          ...
          Pinned.fromPins(
            Pin(size: 252.0, middle: 0.4261),
            Pin(size: 15.0, end: 94.0),
            child: Text(
              'Hesabın yok mu? Yeni bir hesap',
              style: TextStyle(
                fontFamily: 'Arial',
                fontSize: 13,
                color: const Color(0xff000000),
...
const String _svg_d5n0x =
    '<svg viewBox="70.0 754.0 289.0 40.0" ><path transform="translate(70.0, 754.0)" d="M 10 0 L 279 0 C 284.5228576660156 0 289 4.477152347564697 289 10 L 289 30 C 289 35.52284622192383 284.5228576660156 40 279 40 L 10 40 C 4.477152347564697 40 0 35.52284622192383 0 30 L 0 10 C 0 4.477152347564697 4.477152347564697 0 10 0 Z" fill="#3acbc1" stroke="#f2e2e2" stroke-width="2" stroke-miterlimit="4" stroke-linecap="square" /></svg>';
